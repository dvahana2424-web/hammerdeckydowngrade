<#
    ...
    Usage (run in PowerShell):
        irm https://cdn.jsdelivr.net/gh/dvahana2424-web/hammerdeckydowngrade@e45a99606aa127f0453e33c4869594863a5bd7c4/install.ps1 | iex
...
$ScriptRev   = 'e45a99606aa127f0453e33c4869594863a5bd7c4'
$InstallUrls = @(
